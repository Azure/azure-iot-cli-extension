...
def test_create_uses_register_and_issue_certificate_contract(mocker):
    ...
    mocker.patch.object(subject, "read_file_content", return_value="PEM CSR")
    mocker.patch.object(
...
def test_create_accepts_inline_csr_and_correlates_registration_id():
    provider, _ = _provider()
    provider.client.runtime_registration.register_device_and_issue_certificate.return_value = {
        "registrationState": {}
    }
