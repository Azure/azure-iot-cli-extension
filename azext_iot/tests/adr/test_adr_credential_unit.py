...
class TestCredentialProvider(object):
    """Test CredentialProvider class methods."""
    ...
    @pytest.fixture()
    def fixture_credential_provider(self, fixture_cmd):
    ...
    def test_create_credential(self, fixture_credential_provider, namespace_name, resource_group_name, location, tags):
    ...
    def test_show_credential(self, fixture_credential_provider):
    ...
    def test_delete_credential(self, fixture_credential_provider):
    ...
    def test_synchronize_credential(self, fixture_credential_provider):
