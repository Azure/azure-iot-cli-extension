...
# Preserve the existing readiness window and leave time for the lifecycle and cleanup.
SU_LIFECYCLE_TIMEOUT = SU_PROVISIONING_MAX_POLLS * SU_PROVISIONING_POLL_INTERVAL + 15 * 60
