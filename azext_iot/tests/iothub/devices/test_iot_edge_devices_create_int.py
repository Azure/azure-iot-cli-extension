...
class TestNestedEdgeHierarchy(IoTLiveScenarioTest):
    ...
    def test_nested_edge_devices_create_nArgs_full(self):
        ...
        devices: List[EdgeDevicesTestConfig] = [
            ...
            EdgeDevicesTestConfig("device3", "device2", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device4", "device1", None, None, None),
            EdgeDevicesTestConfig("device5", "device4", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device6", "device4", self.deployment_lower, None, None),
    ...
    def test_nested_edge_devices_create_config_full(self):
        ...
        devices: List[EdgeDevicesTestConfig] = [
            EdgeDevicesTestConfig("device_1", None, self.deployment_top, "device_1", "mcr.microsoft.com/azureiotedge-agent:1.1"),
            EdgeDevicesTestConfig("device_2", "device_1", self.deployment_lower, "device_2", None),
            EdgeDevicesTestConfig("device_3", "device_2", self.deployment_lower, "device_3", None),
            EdgeDevicesTestConfig("device_4", "device_1", self.deployment_top, "device_4", None),
            EdgeDevicesTestConfig("device_5", "device_4", self.deployment_lower, "device_5", None),
            EdgeDevicesTestConfig("device_6", "device_4", self.deployment_lower, "device_6", None),
    ...
    def test_nested_edge_devices_create_config_partial(self):
        ...
        devices_primary = [
            EdgeDevicesTestConfig("device_1", None, self.deployment_top, None, None),
            EdgeDevicesTestConfig("device_2", "device_1", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device_3", "device_2", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device_4", "device_1", self.deployment_top, None, None),
            EdgeDevicesTestConfig("device_5", "device_4", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device_6", "device_4", self.deployment_lower, None, None),
            EdgeDevicesTestConfig("device_7", None, None, None, None),
        ]
        devices_secondary = [
            EdgeDevicesTestConfig("device_100", None, self.deployment_top, None, None),
            EdgeDevicesTestConfig("device_200", "device_100", None, None, None),
            EdgeDevicesTestConfig("device_300", "device_200", None, None, None),
            EdgeDevicesTestConfig("device_400", "device_300", self.deployment_lower, None, None),
        ]
        self.cmd(
    ...
    def test_edge_devices_create_config_overrides(self):
        ...
        devices: List[EdgeDevicesTestConfig] = [
            EdgeDevicesTestConfig("device_1", None, None, None, "mcr.microsoft.com/azureiotedge-agent:1.2"),
            EdgeDevicesTestConfig("device_2", "device_1", None, None, default_edge_agent),
            EdgeDevicesTestConfig("device_3", "device_1", None, None, "mcr.microsoft.com/azureiotedge-agent:1.4"),
