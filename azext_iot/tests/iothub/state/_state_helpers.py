...
from azext_iot.tests.iothub.conftest import assign_iot_hub_dataplane_rbac_role
...
@pytest.fixture()
def setup_hub_states_dataplane(provisioned_only_iot_hubs_module, request, tmp_path):
