...
class DeviceRegistryOperationError(Model):
    ...
    :param error_code: ErrorCode associated with the error. Possible values
     ...
     'GenericRequestEntityTooLarge', 'MessageTooLarge', 'TooManyDevices',
     'TooManyModulesOnDevice', 'ConfigurationCountLimitExceeded',
     'GroupCountLimitExceeded', 'GenericUnsupportedMediaType',
