...
def build_central_event_hub_targets(cmd, app_id, central_dns_suffix) -> List[Target]:
...
async def _build_central_event_hub_targets_async(cmd, app_id, central_dns_suffix):
