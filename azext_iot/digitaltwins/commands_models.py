...
def add_models(cmd, name, models=None, from_directory=None, resource_group_name=None):
...
def show_model(cmd, name, model_id, definition=False, resource_group_name=None):
    model_provider = ModelProvider(cmd=cmd, name=name, rg=resource_group_name)
    return model_provider.get(id=model_id, get_definition=definition)


def list_models(
    cmd, name, definition=False, dependencies_for=None, resource_group_name=None
):
    model_provider = ModelProvider(cmd=cmd, name=name, rg=resource_group_name)
...
def update_model(cmd, name, model_id, decommission=None, resource_group_name=None):
