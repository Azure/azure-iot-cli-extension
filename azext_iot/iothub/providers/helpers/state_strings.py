...
SAVE_SPECIFIC_DEVICE_RETRIEVE_FAIL_MSG = "Failed to retrieve device {}. Skipping this device."
SAVE_SPECIFIC_DEVICE_MODULES_RETRIEVE_FAIL_MSG = "Failed to retrieve modules for device {}. Skipping modules for this device."
SAVE_SPECIFIC_DEVICE_SPECIFIC_MODULE_RETRIEVE_FAIL_MSG = "Failed to retrieve module {} for module {} for device {}. \
Skipping this module for this device."
SAVE_ENDPOINT_RETRIEVE_FAIL_MSG = "Failed to retrieve permissions for {} endpoint {}. Skipping this endpoint."
SAVE_ENDPOINT_INFO_RETRIEVE_FAIL_MSG = "Failed to retrieve information for {} endpoint {}. Skipping this endpoint."
SAVE_ROUTE_FAIL_MSG = "Skipping route {} because it relies on endpoint {}."
