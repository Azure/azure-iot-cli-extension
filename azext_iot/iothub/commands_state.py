...
def state_migrate(cmd, hub_name=None, resource_group_name=None, login=None, orig_hub=None, orig_resource_group_name=None, orig_hub_login=None, replace=False, auth_type_dataplane=None):
    sp = StateProvider(cmd=cmd, hub=hub_name, rg=resource_group_name, login=login, auth_type_dataplane=auth_type_dataplane)
