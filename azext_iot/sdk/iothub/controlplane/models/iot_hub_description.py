...
class IotHubDescription(Resource):
    ...
    :type properties: ~service.models.IotHubProperties
    :param sku: Required. IotHub SKU info
    :type sku: ~service.models.IotHubSkuInfo
    :param identity: The managed identities for the IotHub.
    :type identity: ~service.models.ArmIdentity
    :ivar system_data: The system meta data relating to this resource.
    :vartype system_data: ~service.models.SystemData
    """
