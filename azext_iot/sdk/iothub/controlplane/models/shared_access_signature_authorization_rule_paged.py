...
class SharedAccessSignatureAuthorizationRulePaged(Paged):
    """
    A paging container for iterating over a list of :class:`SharedAccessSignatureAuthorizationRule <service.models.SharedAccessSignatureAuthorizationRule>` object
    """
