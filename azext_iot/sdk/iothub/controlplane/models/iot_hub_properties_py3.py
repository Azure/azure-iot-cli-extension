...
class IotHubProperties(Model):
    ...
    def __init__(self, *, authorization_policies=None, disable_local_auth: bool=None, disable_device_sas: bool=None, disable_module_sas: bool=None, restrict_outbound_network_access: bool=None, allowed_fqdn_list=None, public_network_access=None, ip_filter_rules=None, network_rule_sets=None, min_tls_version: str=None, private_endpoint_connections=None, event_hub_endpoints=None, routing=None, storage_endpoints=None, messaging_endpoints=None, enable_file_upload_notifications: bool=None, cloud_to_device=None, comments: str=None, device_streams=None, features=None, encryption=None, enable_data_residency: bool=None, root_certificate=None, **kwargs) -> None:
