...
class IotHubResourceOperations:  # pylint: disable=too-many-public-methods
    ...
    def _update_initial(
        ...
        resource_group_name: str,
        resource_name: str,
        iot_hub_tags: Union[_models.TagsResource, IO],
        **kwargs: Any
    ) -> _models.IotHubDescription:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def list_by_subscription(
        self,
        **kwargs: Any
    ) -> Iterable["_models.IotHubDescription"]:
    ...
    def check_name_availability(
        self,
        operation_inputs: Union[_models.OperationInputs, IO],
        **kwargs: Any
    ) -> _models.IotHubNameAvailabilityInfo:
        """Check if an IoT hub name is available.
    ...
    def test_all_routes(
        ...
        iot_hub_name: str,
        resource_group_name: str,
        input: Union[_models.TestAllRoutesInput, IO],
        **kwargs: Any
    ) -> _models.TestAllRoutesResult:
        """Test all routes.
    ...
    def test_route(
        ...
        iot_hub_name: str,
        resource_group_name: str,
        input: Union[_models.TestRouteInput, IO],
        **kwargs: Any
    ) -> _models.TestRouteResult:
        """Test the new route.
