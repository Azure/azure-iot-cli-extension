...
class IotHubResourceOperations(object):
    ...
    :ivar api_version: The version of the API. Constant value: "2022-04-30-preview".
    """
    ...
    def get(
        ...
        :rtype: ~service.models.IotHubDescription or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        # Construct URL
    ...
    def create_or_update(
        ...
        :param iot_hub_description: The IoT hub metadata and security
         metadata.
        :type iot_hub_description: ~service.models.IotHubDescription
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~service.models.IotHubDescription]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~service.models.IotHubDescription]]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def list_by_subscription(
        ...
        :rtype:
         ~service.models.IotHubDescriptionPaged[~service.models.IotHubDescription]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def get_valid_skus(
        ...
        :rtype:
         ~service.models.IotHubSkuDescriptionPaged[~service.models.IotHubSkuDescription]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def list_event_hub_consumer_groups(
        ...
        :rtype:
         ~service.models.EventHubConsumerGroupInfoPaged[~service.models.EventHubConsumerGroupInfo]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def get_event_hub_consumer_group(
        ...
        :rtype: ~service.models.EventHubConsumerGroupInfo or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def create_event_hub_consumer_group(
        ...
        :type name: str
        :param properties:
        :type properties: ~service.models.EventHubConsumerGroupName
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def list_jobs(
        ...
        :rtype: ~service.models.JobResponsePaged[~service.models.JobResponse]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def get_quota_metrics(
        ...
        :rtype:
         ~service.models.IotHubQuotaMetricInfoPaged[~service.models.IotHubQuotaMetricInfo]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def get_endpoint_health(
        ...
        :rtype:
         ~service.models.EndpointHealthDataPaged[~service.models.EndpointHealthData]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def check_name_availability(
        ...
        :rtype: ~service.models.IotHubNameAvailabilityInfo or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def test_all_routes(
        ...
        :type input: ~service.models.TestAllRoutesInput
        ...
        :rtype: ~service.models.TestAllRoutesResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def test_route(
        ...
        :type input: ~service.models.TestRouteInput
        :param iot_hub_name: IotHub to be tested
        :type iot_hub_name: str
        :param resource_group_name: resource group which Iot Hub belongs to
        :type resource_group_name: str
        ...
        :rtype: ~service.models.TestRouteResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def list_keys(
        ...
        :rtype:
         ~service.models.SharedAccessSignatureAuthorizationRulePaged[~service.models.SharedAccessSignatureAuthorizationRule]
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def get_keys_for_key_name(
        ...
        :return: SharedAccessSignatureAuthorizationRule or ClientRawResponse
         if raw=true
        :rtype: ~service.models.SharedAccessSignatureAuthorizationRule or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorDetailsException<service.models.ErrorDetailsException>`
        """
    ...
    def export_devices(
        ...
        :type export_devices_parameters: ~service.models.ExportDevicesRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
    ...
    def import_devices(
        ...
        :type import_devices_parameters: ~service.models.ImportDevicesRequest
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
