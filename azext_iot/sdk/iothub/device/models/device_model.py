...
class DeviceModel(Model):
    ...
    :param connection_state: Possible values include: 'Disconnected',
     'Connected'
    :type connection_state: str or ~device.models.enum
    :param status: Possible values include: 'enabled', 'disabled'
    :type status: str or ~device.models.enum
    :param status_reason:
    ...
    :type authentication: ~device.models.AuthenticationMechanism
    :param capabilities:
    :type capabilities: ~device.models.DeviceCapabilities
    :param device_scope:
    ...
    def __init__(self, **kwargs):
        super(DeviceModel, self).__init__(**kwargs)
