...
class ExportImportDevice(Model):
    ...
    :type import_mode: str or ~service.models.enum
    ...
    :type properties: ~service.models.PropertyContainer
    ...
    def __init__(self, *, id: str=None, module_id: str=None, e_tag: str=None, import_mode=None, status=None, status_reason: str=None, authentication=None, twin_etag: str=None, tags=None, properties=None, capabilities=None, device_scope: str=None, parent_scopes=None, **kwargs) -> None:
