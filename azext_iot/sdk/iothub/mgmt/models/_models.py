...
class ArmIdentity(_serialization.Model):
    ...
    :vartype type: str or ~iot_hub_client.models.ResourceIdentityType
    :ivar user_assigned_identities: Dictionary of :code:`<ArmUserIdentity>`.
    :vartype user_assigned_identities: dict[str, ~iot_hub_client.models.ArmUserIdentity]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~iot_hub_client.models.ResourceIdentityType
        :keyword user_assigned_identities: Dictionary of :code:`<ArmUserIdentity>`.
        :paramtype user_assigned_identities: dict[str, ~iot_hub_client.models.ArmUserIdentity]
        """
        super().__init__(**kwargs)
...
class CertificateDescription(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.CertificateProperties
    ...
    def __init__(self, *, properties: Optional["_models.CertificateProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~iot_hub_client.models.CertificateProperties
        """
        super().__init__(**kwargs)
...
class CertificateListDescription(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.CertificateDescription]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.CertificateDescription"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.CertificateDescription]
        """
        super().__init__(**kwargs)
        self.value = value
...
class CertificateWithNonceDescription(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.CertificatePropertiesWithNonce
    :ivar id: The resource identifier.
    :vartype id: str
    :ivar name: The name of the certificate.
    :vartype name: str
    ...
    def __init__(self, *, properties: Optional["_models.CertificatePropertiesWithNonce"] = None, **kwargs: Any) -> None:
        ...
        :keyword properties: The description of an X509 CA Certificate including the challenge nonce
         issued for the Proof-Of-Possession flow.
        :paramtype properties: ~iot_hub_client.models.CertificatePropertiesWithNonce
        """
        super().__init__(**kwargs)
        self.properties = properties
        self.id = None
...
class CloudToDeviceProperties(_serialization.Model):
    ...
    :vartype feedback: ~iot_hub_client.models.FeedbackProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype feedback: ~iot_hub_client.models.FeedbackProperties
        """
        super().__init__(**kwargs)
...
class EncryptionPropertiesDescription(_serialization.Model):
    ...
    :vartype key_vault_properties: list[~iot_hub_client.models.KeyVaultKeyProperties]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype key_vault_properties: list[~iot_hub_client.models.KeyVaultKeyProperties]
        """
        super().__init__(**kwargs)
...
class EndpointHealthData(_serialization.Model):
    ...
    :ivar health_status: Health statuses have following meanings. The 'healthy' status shows that
     ...
     "unhealthy", and "dead".
    :vartype health_status: str or ~iot_hub_client.models.EndpointHealthStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype health_status: str or ~iot_hub_client.models.EndpointHealthStatus
...
class EndpointHealthDataListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.EndpointHealthData]
    ...
    def __init__(self, *, value: Optional[List["_models.EndpointHealthData"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.EndpointHealthData]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class EventHubConsumerGroupBodyDescription(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.EventHubConsumerGroupName
    """
    ...
    def __init__(self, *, properties: "_models.EventHubConsumerGroupName", **kwargs: Any) -> None:
        ...
        :paramtype properties: ~iot_hub_client.models.EventHubConsumerGroupName
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class EventHubConsumerGroupsListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.EventHubConsumerGroupInfo]
    ...
    def __init__(self, *, value: Optional[List["_models.EventHubConsumerGroupInfo"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.EventHubConsumerGroupInfo]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class ExportDevicesRequest(_serialization.Model):
    ...
    :vartype authentication_type: str or ~iot_hub_client.models.AuthenticationType
    :ivar identity: Managed identity properties of storage endpoint for export devices.
    :vartype identity: ~iot_hub_client.models.ManagedIdentity
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword authentication_type: Specifies authentication type being used for connecting to the
         storage account. Known values are: "keyBased" and "identityBased".
        :paramtype authentication_type: str or ~iot_hub_client.models.AuthenticationType
        :keyword identity: Managed identity properties of storage endpoint for export devices.
        :paramtype identity: ~iot_hub_client.models.ManagedIdentity
...
class FallbackRouteProperties(_serialization.Model):
    ...
    :vartype source: str or ~iot_hub_client.models.RoutingSource
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword source: The source to which the routing rule is to be applied to. For example,
         ...
         "DeviceLifecycleEvents", "DeviceJobLifecycleEvents", "DigitalTwinChangeEvents",
         "DeviceConnectionStateEvents", and "MqttBrokerMessages".
        :paramtype source: str or ~iot_hub_client.models.RoutingSource
...
class GroupIdInformation(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.GroupIdInformationProperties
    """
    ...
    def __init__(self, *, properties: "_models.GroupIdInformationProperties", **kwargs: Any) -> None:
        ...
        :paramtype properties: ~iot_hub_client.models.GroupIdInformationProperties
        """
        super().__init__(**kwargs)
        self.id = None
        self.name = None
...
class IotHubCapacity(_serialization.Model):
    ...
    :ivar scale_type: The type of the scaling enabled. Known values are: "Automatic", "Manual", and
     "None".
    :vartype scale_type: str or ~iot_hub_client.models.IotHubScaleType
    """
...
class IotHubDescription(Resource):
    ...
    :vartype properties: ~iot_hub_client.models.IotHubProperties
    :ivar sku: IotHub SKU info. Required.
    :vartype sku: ~iot_hub_client.models.IotHubSkuInfo
    :ivar identity: The managed identities for the IotHub.
    :vartype identity: ~iot_hub_client.models.ArmIdentity
    :ivar system_data: The system meta data relating to this resource.
    :vartype system_data: ~iot_hub_client.models.SystemData
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype properties: ~iot_hub_client.models.IotHubProperties
        :keyword sku: IotHub SKU info. Required.
        :paramtype sku: ~iot_hub_client.models.IotHubSkuInfo
        :keyword identity: The managed identities for the IotHub.
        :paramtype identity: ~iot_hub_client.models.ArmIdentity
        """
...
class IotHubDescriptionListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.IotHubDescription]
    :ivar next_link: The next link.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.IotHubDescription"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.IotHubDescription]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class IotHubLocationDescription(_serialization.Model):
    ...
    :vartype role: str or ~iot_hub_client.models.IotHubReplicaRoleType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype role: str or ~iot_hub_client.models.IotHubReplicaRoleType
        """
        super().__init__(**kwargs)
        self.location = location
        self.role = role
...
class IotHubNameAvailabilityInfo(_serialization.Model):
    ...
    :vartype reason: str or ~iot_hub_client.models.IotHubNameUnavailabilityReason
...
class IotHubProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype authorization_policies:
     list[~iot_hub_client.models.SharedAccessSignatureAuthorizationRule]
    ...
    :vartype public_network_access: str or ~iot_hub_client.models.PublicNetworkAccess
    :ivar ip_filter_rules: The IP filter rules.
    :vartype ip_filter_rules: list[~iot_hub_client.models.IpFilterRule]
    :ivar network_rule_sets: Network Rule Set Properties of IotHub.
    :vartype network_rule_sets: ~iot_hub_client.models.NetworkRuleSetProperties
    ...
    :vartype private_endpoint_connections: list[~iot_hub_client.models.PrivateEndpointConnection]
    ...
    :vartype event_hub_endpoints: dict[str, ~iot_hub_client.models.EventHubProperties]
    :ivar routing: The routing related properties of the IoT hub. See:
     https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging.
    :vartype routing: ~iot_hub_client.models.RoutingProperties
    ...
    :vartype storage_endpoints: dict[str, ~iot_hub_client.models.StorageEndpointProperties]
    :ivar messaging_endpoints: The messaging endpoint properties for the file upload notification
     queue.
    :vartype messaging_endpoints: dict[str, ~iot_hub_client.models.MessagingEndpointProperties]
    ...
    :vartype cloud_to_device: ~iot_hub_client.models.CloudToDeviceProperties
    :ivar comments: IoT hub comments.
    :vartype comments: str
    :ivar device_streams: The device streams properties of iothub.
    :vartype device_streams: ~iot_hub_client.models.IotHubPropertiesDeviceStreams
    :ivar features: The capabilities and features enabled for the IoT hub. Known values are: "None"
     and "DeviceManagement".
    :vartype features: str or ~iot_hub_client.models.Capabilities
    :ivar encryption: The encryption properties for the IoT hub.
    :vartype encryption: ~iot_hub_client.models.EncryptionPropertiesDescription
    :ivar locations: Primary and secondary location for iot hub.
    :vartype locations: list[~iot_hub_client.models.IotHubLocationDescription]
    ...
    :vartype root_certificate: ~iot_hub_client.models.RootCertificateProperties
    ...
    :vartype ip_version: str or ~iot_hub_client.models.IpVersion
    :ivar adr_properties: Represents properties related to the Azure Device Registry (ADR).
    :vartype adr_properties: ~iot_hub_client.models.AdrProperties
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword public_network_access: Whether requests from Public Network are allowed. Known values
         are: "Enabled" and "Disabled".
        :paramtype public_network_access: str or ~iot_hub_client.models.PublicNetworkAccess
        :keyword ip_filter_rules: The IP filter rules.
        :paramtype ip_filter_rules: list[~iot_hub_client.models.IpFilterRule]
        :keyword network_rule_sets: Network Rule Set Properties of IotHub.
        :paramtype network_rule_sets: ~iot_hub_client.models.NetworkRuleSetProperties
        ...
        :paramtype private_endpoint_connections: list[~iot_hub_client.models.PrivateEndpointConnection]
        ...
        :paramtype event_hub_endpoints: dict[str, ~iot_hub_client.models.EventHubProperties]
        :keyword routing: The routing related properties of the IoT hub. See:
         https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging.
        :paramtype routing: ~iot_hub_client.models.RoutingProperties
        :keyword storage_endpoints: The list of Azure Storage endpoints where you can upload files.
         Currently you can configure only one Azure Storage account and that MUST have its key as
         $default. Specifying more than one storage account causes an error to be thrown. Not specifying
         a value for this property when the enableFileUploadNotifications property is set to True,
         causes an error to be thrown.
        :paramtype storage_endpoints: dict[str, ~iot_hub_client.models.StorageEndpointProperties]
        :keyword messaging_endpoints: The messaging endpoint properties for the file upload
         notification queue.
        :paramtype messaging_endpoints: dict[str, ~iot_hub_client.models.MessagingEndpointProperties]
        ...
        :paramtype root_certificate: ~iot_hub_client.models.RootCertificateProperties
        ...
        :paramtype ip_version: str or ~iot_hub_client.models.IpVersion
        :keyword adr_properties: Represents properties related to the Azure Device Registry (ADR).
        :paramtype adr_properties: ~iot_hub_client.models.AdrProperties
        """
        super().__init__(**kwargs)
...
class IotHubQuotaMetricInfoListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.IotHubQuotaMetricInfo]
    :ivar next_link: The next link.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.IotHubQuotaMetricInfo"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.IotHubQuotaMetricInfo]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class IotHubSkuDescription(_serialization.Model):
    ...
    :vartype capacity: ~iot_hub_client.models.IotHubCapacity
    """
    ...
    def __init__(self, *, sku: "_models.IotHubSkuInfo", capacity: "_models.IotHubCapacity", **kwargs: Any) -> None:
        ...
        :paramtype capacity: ~iot_hub_client.models.IotHubCapacity
        """
        super().__init__(**kwargs)
...
class IotHubSkuDescriptionListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.IotHubSkuDescription]
    :ivar next_link: The next link.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.IotHubSkuDescription"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.IotHubSkuDescription]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class IotHubSkuInfo(_serialization.Model):
    ...
    :ivar name: The name of the SKU. Required. Known values are: "F1", "S1", "S2", "S3", "B1",
     "B2", "B3", "P1", "P2", and "P3".
    :vartype name: str or ~iot_hub_client.models.IotHubSku
    :ivar tier: The billing tier for the IoT hub. Known values are: "Free", "Standard", "Basic",
     and "Premium".
    :vartype tier: str or ~iot_hub_client.models.IotHubSkuTier
    ...
    def __init__(self, *, name: Union[str, "_models.IotHubSku"], capacity: Optional[int] = None, **kwargs: Any) -> None:
        ...
        :keyword name: The name of the SKU. Required. Known values are: "F1", "S1", "S2", "S3", "B1",
         "B2", "B3", "P1", "P2", and "P3".
        :paramtype name: str or ~iot_hub_client.models.IotHubSku
...
class IpFilterRule(_serialization.Model):
    ...
    :vartype action: str or ~iot_hub_client.models.IpFilterActionType
    ...
    def __init__(
        ...
        :keyword action: The desired action for requests captured by this rule. Required. Known values
         are: "Accept" and "Reject".
        :paramtype action: str or ~iot_hub_client.models.IpFilterActionType
...
class JobResponse(_serialization.Model):
    ...
    :vartype type: str or ~iot_hub_client.models.JobType
    :ivar status: The status of the job. Known values are: "unknown", "enqueued", "running",
     "completed", "failed", and "cancelled".
    :vartype status: str or ~iot_hub_client.models.JobStatus
...
class JobResponseListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.JobResponse]
    :ivar next_link: The next link.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.JobResponse"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.JobResponse]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class MatchedRoute(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.RouteProperties
    """
    ...
    def __init__(self, *, properties: Optional["_models.RouteProperties"] = None, **kwargs: Any) -> None:
        ...
        :paramtype properties: ~iot_hub_client.models.RouteProperties
        """
        super().__init__(**kwargs)
        self.properties = properties
...
class NetworkRuleSetIpRule(_serialization.Model):
    ...
    :vartype action: str or ~iot_hub_client.models.NetworkRuleIPAction
    :ivar ip_mask: A string that contains the IP address range in CIDR notation for the rule.
     Required.
    :vartype ip_mask: str
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype action: str or ~iot_hub_client.models.NetworkRuleIPAction
        :keyword ip_mask: A string that contains the IP address range in CIDR notation for the rule.
         Required.
        :paramtype ip_mask: str
        """
...
class NetworkRuleSetProperties(_serialization.Model):
    ...
    :ivar default_action: Default Action for Network Rule Set. Known values are: "Deny" and
     "Allow".
    :vartype default_action: str or ~iot_hub_client.models.DefaultAction
    ...
    :vartype ip_rules: list[~iot_hub_client.models.NetworkRuleSetIpRule]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword default_action: Default Action for Network Rule Set. Known values are: "Deny" and
         "Allow".
        :paramtype default_action: str or ~iot_hub_client.models.DefaultAction
        ...
        :paramtype ip_rules: list[~iot_hub_client.models.NetworkRuleSetIpRule]
        """
        super().__init__(**kwargs)
...
class Operation(_serialization.Model):
    ...
    :vartype display: ~iot_hub_client.models.OperationDisplay
    """
    ...
    def __init__(self, *, display: Optional["_models.OperationDisplay"] = None, **kwargs: Any) -> None:
        ...
        :paramtype display: ~iot_hub_client.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = None
...
class OperationListResult(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.Operation]
...
class PrivateEndpointConnection(_serialization.Model):
    ...
    :vartype properties: ~iot_hub_client.models.PrivateEndpointConnectionProperties
    """
    ...
    def __init__(self, *, properties: "_models.PrivateEndpointConnectionProperties", **kwargs: Any) -> None:
        ...
        :paramtype properties: ~iot_hub_client.models.PrivateEndpointConnectionProperties
        """
        super().__init__(**kwargs)
        self.id = None
        self.name = None
...
class PrivateEndpointConnectionProperties(_serialization.Model):
    ...
    :vartype private_endpoint: ~iot_hub_client.models.PrivateEndpoint
    :ivar private_link_service_connection_state: The current state of a private endpoint
     connection. Required.
    :vartype private_link_service_connection_state:
     ~iot_hub_client.models.PrivateLinkServiceConnectionState
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype private_endpoint: ~iot_hub_client.models.PrivateEndpoint
...
class PrivateLinkResources(_serialization.Model):
    ...
    :vartype value: list[~iot_hub_client.models.GroupIdInformation]
    """
    ...
    def __init__(self, *, value: Optional[List["_models.GroupIdInformation"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype value: list[~iot_hub_client.models.GroupIdInformation]
        """
        super().__init__(**kwargs)
        self.value = value
...
class PrivateLinkServiceConnectionState(_serialization.Model):
    ...
    :vartype status: str or ~iot_hub_client.models.PrivateLinkServiceConnectionStatus
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword status: The status of a private endpoint connection. Required. Known values are:
         "Pending", "Approved", "Rejected", and "Disconnected".
        :paramtype status: str or ~iot_hub_client.models.PrivateLinkServiceConnectionStatus
...
class RouteCompilationError(_serialization.Model):
    ...
    :vartype severity: str or ~iot_hub_client.models.RouteErrorSeverity
    :ivar location: Location where the route error happened.
    :vartype location: ~iot_hub_client.models.RouteErrorRange
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype severity: str or ~iot_hub_client.models.RouteErrorSeverity
        :keyword location: Location where the route error happened.
        :paramtype location: ~iot_hub_client.models.RouteErrorRange
        """
        super().__init__(**kwargs)
        self.message = message
...
class RouteErrorRange(_serialization.Model):
    ...
    :vartype start: ~iot_hub_client.models.RouteErrorPosition
    :ivar end: End where the route error happened.
    :vartype end: ~iot_hub_client.models.RouteErrorPosition
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype start: ~iot_hub_client.models.RouteErrorPosition
        :keyword end: End where the route error happened.
        :paramtype end: ~iot_hub_client.models.RouteErrorPosition
        """
        super().__init__(**kwargs)
        self.start = start
        self.end = end
...
class RoutingEndpoints(_serialization.Model):
    ...
    :vartype service_bus_queues:
     list[~iot_hub_client.models.RoutingServiceBusQueueEndpointProperties]
    :ivar service_bus_topics: The list of Service Bus topic endpoints that the IoT hub routes the
     messages to, based on the routing rules.
    :vartype service_bus_topics:
     list[~iot_hub_client.models.RoutingServiceBusTopicEndpointProperties]
    ...
    :vartype event_hubs: list[~iot_hub_client.models.RoutingEventHubProperties]
    ...
    :vartype storage_containers: list[~iot_hub_client.models.RoutingStorageContainerProperties]
    :ivar cosmos_db_sql_containers: The list of Cosmos DB container endpoints that IoT hub routes
     messages to, based on the routing rules.
    :vartype cosmos_db_sql_containers: list[~iot_hub_client.models.RoutingCosmosDBSqlApiProperties]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword event_hubs: The list of Event Hubs endpoints that IoT hub routes messages to, based on
         the routing rules. This list does not include the built-in Event Hubs endpoint.
        :paramtype event_hubs: list[~iot_hub_client.models.RoutingEventHubProperties]
        :keyword storage_containers: The list of storage container endpoints that IoT hub routes
         messages to, based on the routing rules.
        :paramtype storage_containers: list[~iot_hub_client.models.RoutingStorageContainerProperties]
        ...
        :paramtype cosmos_db_sql_containers:
         list[~iot_hub_client.models.RoutingCosmosDBSqlApiProperties]
        """
        super().__init__(**kwargs)
...
class RoutingProperties(_serialization.Model):
    ...
    :ivar endpoints: The properties related to the custom endpoints to which your IoT hub routes
     ...
     for free hubs.
    :vartype endpoints: ~iot_hub_client.models.RoutingEndpoints
    ...
    :vartype routes: list[~iot_hub_client.models.RouteProperties]
    ...
    :vartype fallback_route: ~iot_hub_client.models.FallbackRouteProperties
    ...
    :vartype enrichments: list[~iot_hub_client.models.EnrichmentProperties]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword endpoints: The properties related to the custom endpoints to which your IoT hub routes
         ...
         endpoint types for paid hubs and only 1 custom endpoint is allowed across all endpoint types
         for free hubs.
        :paramtype endpoints: ~iot_hub_client.models.RoutingEndpoints
        ...
        :paramtype routes: list[~iot_hub_client.models.RouteProperties]
        ...
        :paramtype fallback_route: ~iot_hub_client.models.FallbackRouteProperties
        ...
        :paramtype enrichments: list[~iot_hub_client.models.EnrichmentProperties]
        """
        super().__init__(**kwargs)
...
class RoutingStorageContainerProperties(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype encoding: str or ~iot_hub_client.models.RoutingStorageContainerPropertiesEncoding
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword encoding: Encoding that is used to serialize messages to blobs. Supported values are
         'avro', 'avrodeflate', and 'JSON'. Default value is 'avro'. Known values are: "Avro",
         "AvroDeflate", and "JSON".
        :paramtype encoding: str or ~iot_hub_client.models.RoutingStorageContainerPropertiesEncoding
        """
        super().__init__(**kwargs)
        self.id = id
        self.connection_string = connection_string
...
class RoutingTwin(_serialization.Model):
    ...
    :vartype tags: JSON
    :ivar properties:
    :vartype properties: ~iot_hub_client.models.RoutingTwinProperties
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype tags: JSON
        :keyword properties:
        :paramtype properties: ~iot_hub_client.models.RoutingTwinProperties
        """
        super().__init__(**kwargs)
        self.tags = tags
        self.properties = properties
...
class SharedAccessSignatureAuthorizationRule(_serialization.Model):
    ...
    :vartype rights: str or ~iot_hub_client.models.AccessRights
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword rights: The permissions assigned to the shared access policy. Required. Known values
         ...
         "RegistryRead, ServiceConnect, DeviceConnect", "RegistryWrite, ServiceConnect, DeviceConnect",
         and "RegistryRead, RegistryWrite, ServiceConnect, DeviceConnect".
        :paramtype rights: str or ~iot_hub_client.models.AccessRights
        """
        super().__init__(**kwargs)
...
class SharedAccessSignatureAuthorizationRuleListResult(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype value: list[~iot_hub_client.models.SharedAccessSignatureAuthorizationRule]
    :ivar next_link: The next link.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~iot_hub_client.models.SharedAccessSignatureAuthorizationRule]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
...
class SystemData(_serialization.Model):
    ...
    :vartype created_by_type: str or ~iot_hub_client.models.CreatedByType
    ...
    :vartype last_modified_by_type: str or ~iot_hub_client.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~iot_hub_client.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~iot_hub_client.models.CreatedByType
...
class TestAllRoutesInput(_serialization.Model):
    ...
    :vartype routing_source: str or ~iot_hub_client.models.RoutingSource
    :ivar message: Routing message.
    :vartype message: ~iot_hub_client.models.RoutingMessage
    :ivar twin: Routing Twin Reference.
    :vartype twin: ~iot_hub_client.models.RoutingTwin
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword routing_source: Routing source. Known values are: "Invalid", "DeviceMessages",
         "TwinChangeEvents", "DeviceLifecycleEvents", "DeviceJobLifecycleEvents",
         "DigitalTwinChangeEvents", "DeviceConnectionStateEvents", and "MqttBrokerMessages".
        :paramtype routing_source: str or ~iot_hub_client.models.RoutingSource
        :keyword message: Routing message.
        :paramtype message: ~iot_hub_client.models.RoutingMessage
        :keyword twin: Routing Twin Reference.
        :paramtype twin: ~iot_hub_client.models.RoutingTwin
        """
        super().__init__(**kwargs)
...
class TestAllRoutesResult(_serialization.Model):
    ...
    :vartype routes: list[~iot_hub_client.models.MatchedRoute]
    """
    ...
    def __init__(self, *, routes: Optional[List["_models.MatchedRoute"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype routes: list[~iot_hub_client.models.MatchedRoute]
        """
        super().__init__(**kwargs)
        self.routes = routes
...
class TestRouteInput(_serialization.Model):
    ...
    :vartype route: ~iot_hub_client.models.RouteProperties
    :ivar twin: Routing Twin Reference.
    :vartype twin: ~iot_hub_client.models.RoutingTwin
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype route: ~iot_hub_client.models.RouteProperties
        :keyword twin: Routing Twin Reference.
        :paramtype twin: ~iot_hub_client.models.RoutingTwin
        """
        super().__init__(**kwargs)
...
class TestRouteResult(_serialization.Model):
    ...
    :vartype result: str or ~iot_hub_client.models.TestResultStatus
    :ivar details: Detailed result of testing route.
    :vartype details: ~iot_hub_client.models.TestRouteResultDetails
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype result: str or ~iot_hub_client.models.TestResultStatus
        :keyword details: Detailed result of testing route.
        :paramtype details: ~iot_hub_client.models.TestRouteResultDetails
        """
        super().__init__(**kwargs)
        self.result = result
...
class TestRouteResultDetails(_serialization.Model):
    ...
    :vartype compilation_errors: list[~iot_hub_client.models.RouteCompilationError]
    """
    ...
    def __init__(
        ...
        :paramtype compilation_errors: list[~iot_hub_client.models.RouteCompilationError]
        """
        super().__init__(**kwargs)
...
class UserSubscriptionQuota(_serialization.Model):
    ...
    :vartype name: ~iot_hub_client.models.Name
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype name: ~iot_hub_client.models.Name
        """
        super().__init__(**kwargs)
        self.id = id
        self.type = type
...
class UserSubscriptionQuotaListResult(_serialization.Model):
    ...
    :ivar value:
    :vartype value: list[~iot_hub_client.models.UserSubscriptionQuota]
    :ivar next_link:
    :vartype next_link: str
    """
    ...
    def __init__(self, *, value: Optional[List["_models.UserSubscriptionQuota"]] = None, **kwargs: Any) -> None:
        """
        :keyword value:
        :paramtype value: list[~iot_hub_client.models.UserSubscriptionQuota]
        """
        super().__init__(**kwargs)
        self.value = value
        self.next_link = None
