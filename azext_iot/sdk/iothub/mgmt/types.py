...
AuthenticationType = Literal["keyBased", "identityBased"]
"""Specifies authentication type being used for connecting to the storage account."""

Capabilities = Literal["None", "DeviceManagement"]
"""The capabilities and features enabled for the IoT hub."""

ConnectionProfile = Literal["Classic", "MqttV5"]
...
DefaultAction = Literal["Deny", "Allow"]
"""Default Action for Network Rule Set."""

DeviceRegistryIdentityType = Literal["SystemAssigned", "UserAssigned"]
"""The type of the identity."""

DeviceRegistryLinkingState = Literal["InProgress", "Success", "Orphaned", "Failed"]
"""Indicates whether the IoT Hub is linked with an Azure Device Registry."""

EndpointHealthStatus = Literal["unknown", "healthy", "degraded", "unhealthy", "dead"]
...
IotHubNameUnavailabilityReason = Literal["Invalid", "AlreadyExists"]
"""The reason for unavailability."""

IotHubReplicaRoleType = Literal["primary", "secondary"]
...
IotHubScaleType = Literal["Automatic", "Manual", "None"]
"""The type of the scaling enabled."""

IotHubSku = Literal["F1", "S1", "S2", "S3", "B1", "B2", "B3"]
"""The name of the SKU."""

IotHubSkuTier = Literal["Free", "Standard", "Basic"]
...
NetworkRuleIPAction = Literal["Allow"]
"""IP Filter Action."""
...
ResourceIdentityType = Literal["SystemAssigned", "UserAssigned", "SystemAssigned, UserAssigned", "None"]
"""The type of identity used for the resource. The type 'SystemAssigned,UserAssigned' includes
both an implicitly created identity and a set of user assigned identities. The type 'None' will
remove any identities from the service."""

RouteErrorSeverity = Literal["error", "warning"]
...
class ArmIdentity(TypedDict, total=False):
    ...
    :vartype type: ResourceIdentityType
...
class CertificateListDescription(TypedDict, total=False):
    ...
    :vartype value: list["CertificateDescription"]
    """
...
class CertificatePropertiesWithNonce(TypedDict, total=False):
    ...
    :ivar updated: The certificate's last update date and time.
    :vartype updated: str
    :ivar verificationCode: The certificate's verification code that will be used for proof of
     possession.
...
class CertificateWithNonceDescription(TypedDict, total=False):
    """The X509 Certificate.
    ...
    :vartype properties: "CertificatePropertiesWithNonce"
...
class DeviceRegistryIdentity(TypedDict, total=False):
    ...
    :vartype type: DeviceRegistryIdentityType
...
class DeviceRegistryLinkingProperties(TypedDict, total=False):
    ...
    :vartype state: DeviceRegistryLinkingState
...
class EndpointHealthData(TypedDict, total=False):
    ...
    :ivar endpointId: Id of the endpoint.
    :vartype endpointId: str
    :ivar healthStatus: Health statuses have following meanings. The 'healthy' status shows that
     ...
     "unhealthy", and "dead".
    :vartype healthStatus: EndpointHealthStatus
    :ivar lastKnownError: Last error obtained when a message failed to be delivered to iot hub.
    :vartype lastKnownError: str
    :ivar lastKnownErrorTime: Time at which the last known error occurred.
    :vartype lastKnownErrorTime: str
    :ivar lastSuccessfulSendAttemptTime: Last time iot hub successfully sent a message to the
     endpoint.
    :vartype lastSuccessfulSendAttemptTime: str
    :ivar lastSendAttemptTime: Last time iot hub tried to send a message to the endpoint.
    :vartype lastSendAttemptTime: str
    """
...
class ExportDevicesRequest(TypedDict, total=False):
    ...
    :vartype authenticationType: AuthenticationType
...
class GroupIdInformation(TypedDict, total=False):
...
class IotHubCapacity(TypedDict, total=False):
    ...
    :vartype default: int
    :ivar scaleType: The type of the scaling enabled. Known values are: "Automatic", "Manual", and
     "None".
    :vartype scaleType: IotHubScaleType
    """
...
class IotHubDetails(TypedDict, total=False):
    ...
    :vartype gatewayVersion: GatewayVersion
    """
...
class IotHubLocationDescription(TypedDict, total=False):
    ...
    :vartype role: IotHubReplicaRoleType
    """
...
class IotHubNameAvailabilityInfo(TypedDict, total=False):
    """The properties indicating whether a given IoT hub name is available.

    :ivar nameAvailable: The value which indicates whether the provided name is available.
    :vartype nameAvailable: bool
    :ivar reason: The reason for unavailability. Known values are: "Invalid" and "AlreadyExists".
    :vartype reason: IotHubNameUnavailabilityReason
...
class IotHubProperties(TypedDict, total=False):
    ...
    :vartype connectionProfile: ConnectionProfile
...
class IotHubQuotaMetricInfo(TypedDict, total=False):
    ...
    :vartype name: str
    :ivar currentValue: The current value for the quota metric.
    :vartype currentValue: int
    :ivar maxValue: The maximum value of the quota metric.
    :vartype maxValue: int
    """
...
class IotHubSkuDescription(TypedDict, total=False):
    """SKU properties.

    :ivar resourceType: The type of the resource.
    :vartype resourceType: str
    :ivar sku: The type of the resource. Required.
    :vartype sku: "IotHubSkuInfo"
    :ivar capacity: IotHub capacity. Required.
    :vartype capacity: "IotHubCapacity"
    """
    ...
    capacity: Required["IotHubCapacity"]
...
class JobResponse(TypedDict, total=False):
    ...
    :ivar jobId: The job identifier.
    :vartype jobId: str
    :ivar startTimeUtc: The start time of the job.
    :vartype startTimeUtc: str
    :ivar endTimeUtc: The time the job stopped processing.
    ...
    :vartype type: JobType
    :ivar status: The status of the job. Known values are: "unknown", "enqueued", "running",
     "completed", "failed", and "cancelled".
    :vartype status: JobStatus
    :ivar failureReason: If status == failed, this string containing the reason for the failure.
    :vartype failureReason: str
    :ivar statusMessage: The status message for the job.
    :vartype statusMessage: str
    :ivar parentJobId: The job identifier of the parent job, if any.
    :vartype parentJobId: str
    """
...
class MatchedRoute(TypedDict, total=False):
    """Routes that matched.
...
class Name(TypedDict, total=False):
    ...
    :vartype value: str
    :ivar localizedValue: Localized value of name.
...
class NetworkRuleSetIpRule(TypedDict, total=False):
    ...
    :vartype action: NetworkRuleIPAction
    :ivar ipMask: A string that contains the IP address range in CIDR notation for the rule.
     Required.
    :vartype ipMask: str
    """
...
class NetworkRuleSetProperties(TypedDict, total=False):
    ...
    :vartype defaultAction: DefaultAction
...
class RegistryStatistics(TypedDict, total=False):
    """Identity registry statistics.

    :ivar totalDeviceCount: The total count of devices in the identity registry.
    :vartype totalDeviceCount: int
    :ivar enabledDeviceCount: The count of enabled devices in the identity registry.
    :vartype enabledDeviceCount: int
    :ivar disabledDeviceCount: The count of disabled devices in the identity registry.
    :vartype disabledDeviceCount: int
    """
...
class RouteErrorPosition(TypedDict, total=False):
...
class RouteErrorRange(TypedDict, total=False):
    """Range of route errors.

    :ivar start: Start where the route error happened.
    :vartype start: "RouteErrorPosition"
    :ivar end: End where the route error happened.
    :vartype end: "RouteErrorPosition"
    """
...
class RoutingEventStreamProperties(TypedDict, total=False):
    ...
    :ivar authenticationType: Method used to authenticate against the event stream endpoint.
     "identityBased"
    :vartype authenticationType: EventStreamAuthenticationType
...
class RoutingStorageContainerProperties(TypedDict, total=False):
    ...
    :vartype encoding: RoutingStorageContainerPropertiesEncoding
    """
...
class TestAllRoutesResult(TypedDict, total=False):
    """Result of testing all routes.

    :ivar routes: JSON-serialized array of matched routes.
    :vartype routes: list["MatchedRoute"]
    """
...
class TestRouteResultDetails(TypedDict, total=False):
    """Detailed result of testing a route.

    :ivar compilationErrors: JSON-serialized list of route compilation errors.
    :vartype compilationErrors: list["RouteCompilationError"]
    """

    compilationErrors: list["RouteCompilationError"]
...
class UserSubscriptionQuota(TypedDict, total=False):
    ...
    :vartype unit: str
    :ivar currentValue: Current number of IotHub type.
    :vartype currentValue: int
...
class UserSubscriptionQuotaListResult(TypedDict, total=False):
    """Json-serialized array of User subscription quota response.

    :ivar value: The UserSubscriptionQuota items on this page.
    :vartype value: list["UserSubscriptionQuota"]
    :ivar nextLink: The link to the next page of items.
