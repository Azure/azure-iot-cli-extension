...
class IndividualEnrollmentOperations(object):
    ...
    def get(
        ...
        :rtype: ~dps.service.models.IndividualEnrollment or
    ...
    def create_or_update(
        ...
        :param id: This id is used to uniquely identify a device registration
         ...
         -. No special characters allowed at start or end.
        :type id: str
        :param body: The device enrollment record.
        :type body: ~dps.service.models.IndividualEnrollment
        :param if_match: The ETag of the enrollment record.
        :type if_match: str
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
        ...
        # Construct body
        body_content = self._serialize.body(body, 'IndividualEnrollment')
    ...
    def query(
        ...
        :rtype: list[~dps.service.models.IndividualEnrollment] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ProvisioningServiceErrorDetailsException<dps.service.models.ProvisioningServiceErrorDetailsException>`
        """
    ...
    def run_bulk_operation(
        ...
        :type enrollments: list[~dps.service.models.IndividualEnrollment]
        :param mode: Operation mode. Possible values include: 'create',
         'update', 'updateIfMatchETag', 'delete'
        :type mode: str or ~dps.service.models.BulkEnrollmentMode
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :return: BulkEnrollmentOperationResult or ClientRawResponse if
         raw=true
        :rtype: ~dps.service.models.BulkEnrollmentOperationResult or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ProvisioningServiceErrorDetailsException<dps.service.models.ProvisioningServiceErrorDetailsException>`
        """
        body = models.BulkEnrollmentOperation(enrollments=enrollments, mode=mode)
        ...
        # Construct body
        body_content = self._serialize.body(body, 'BulkEnrollmentOperation')
