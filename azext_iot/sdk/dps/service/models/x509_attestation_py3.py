...
class X509Attestation(Model):
    ...
    :type client_certificates: ~dps.service.models.X509Certificates
    :param signing_certificates:
    :type signing_certificates: ~dps.service.models.X509Certificates
    :param ca_references:
    :type ca_references: ~dps.service.models.X509CAReferences
    """
