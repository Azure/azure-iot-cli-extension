...
class CertificateAuthority(Model):
    ...
    sub-classes are: AzurePkiCertificateAuthority,
    DigiCertCertificateAuthority, GlobalSignCertificateAuthority,
    ...
    _subtype_map = {
        'certificate_authority_type': {'AzurePkiCertificateAuthority': 'AzurePkiCertificateAuthority', 'DigiCertCertificateAuthority': 'DigiCertCertificateAuthority', 'GlobalSignCertificateAuthority': 'GlobalSignCertificateAuthority', 'PrivatePreviewManagedCertificateAuthority': 'PrivatePreviewManagedCertificateAuthority'}
    }
