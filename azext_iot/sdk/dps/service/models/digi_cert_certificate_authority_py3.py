...
class DigiCertCertificateAuthority(CertificateAuthority):
    ...
    :param profile_name: The customer specific DigiCert certificate authority
     profile name needed to identify their issuing CA instance.
    :type profile_name: str
    :param api_key: The API key required to authenticate with DigiCert.
    :type api_key: str
    """
    ...
    def __init__(self, *, profile_name: str=None, api_key: str=None, **kwargs) -> None:
        super(DigiCertCertificateAuthority, self).__init__(**kwargs)
        self.profile_name = profile_name
        self.api_key = api_key
        self.certificate_authority_type = 'DigiCertCertificateAuthority'
