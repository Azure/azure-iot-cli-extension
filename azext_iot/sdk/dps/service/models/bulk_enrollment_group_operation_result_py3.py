...
class BulkEnrollmentGroupOperationResult(Model):
    """Results of a bulk enrollment group operation.

    All required parameters must be populated in order to send to Azure.

    :param errors: Registration errors
    :type errors: list[~dps.service.models.BulkEnrollmentGroupOperationError]
    ...
    _attribute_map = {
        'errors': {'key': 'errors', 'type': '[BulkEnrollmentGroupOperationError]'},
        'is_successful': {'key': 'isSuccessful', 'type': 'bool'},
    }

    def __init__(self, *, is_successful: bool, errors=None, **kwargs) -> None:
        super(BulkEnrollmentGroupOperationResult, self).__init__(**kwargs)
        self.errors = errors
