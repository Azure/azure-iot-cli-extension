...
class GlobalSignCertificateAuthority(CertificateAuthority):
    ...
    :param api_key: The customer specific GlobalSign certificate authority API
     key needed to identify their issuing CA instance.
    :type api_key: str
    :param api_secret: The API secret required to authenticate with
     GlobalSign.
    :type api_secret: str
    """
    ...
    def __init__(self, *, api_key: str=None, api_secret: str=None, **kwargs) -> None:
        super(GlobalSignCertificateAuthority, self).__init__(**kwargs)
        self.api_key = api_key
        self.api_secret = api_secret
        self.certificate_authority_type = 'GlobalSignCertificateAuthority'
