...
class IotDpsClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype operations: iot_dps_client.operations.Operations
    :ivar iot_dps_resource: IotDpsResourceOperations operations
    :vartype iot_dps_resource: iot_dps_client.operations.IotDpsResourceOperations
    :ivar dps_certificate: DpsCertificateOperations operations
    :vartype dps_certificate: iot_dps_client.operations.DpsCertificateOperations
