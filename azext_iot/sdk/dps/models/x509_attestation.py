...
class X509Attestation(Model):
    ...
    :type client_certificates:
     ~microsoft.azure.management.provisioningservices.models.X509Certificates
    :param signing_certificates:
    :type signing_certificates:
     ~microsoft.azure.management.provisioningservices.models.X509Certificates
    :param ca_references:
    :type ca_references:
     ~microsoft.azure.management.provisioningservices.models.X509CAReferences
    """
    ...
    def __init__(self, client_certificates=None, signing_certificates=None, ca_references=None):
        super(X509Attestation, self).__init__()
