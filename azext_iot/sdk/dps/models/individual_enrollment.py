...
class IndividualEnrollment(Model):
    ...
    :vartype registration_state:
     ~microsoft.azure.management.provisioningservices.models.IndividualEnrollmentRegistrationState
    ...
    _attribute_map = {
        ...
        'registration_state': {'key': 'registrationState', 'type': 'IndividualEnrollmentRegistrationState'},
    ...
    def __init__(self, registration_id, attestation, capabilities=None, device_id=None, iot_hub_host_name=None, initial_twin=None, etag=None, provisioning_status="enabled", reprovision_policy=None, allocation_policy=None, iot_hubs=None, custom_allocation_definition=None):
