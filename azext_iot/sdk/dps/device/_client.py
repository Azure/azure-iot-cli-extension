...
from .operations import DeviceUpdateOperations, RuntimeRegistrationOperations
...
class ProvisioningDeviceClient:  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype device_update: azext_iot.sdk.dps.device.operations.DeviceUpdateOperations
