...
class DeviceRegistrationResult(Model):
    """Device registration result.

    Variables are only populated by the server, and will be ignored when
    sending a request.

    :ivar tpm: Registration result returned when using TPM attestation.
    :vartype tpm: ~dps.models.TpmRegistrationResult
    :ivar x509: Registration result returned when using X509 attestation.
    :vartype x509: ~dps.models.X509RegistrationResult
    :ivar symmetric_key: Registration result returned when using SymmetricKey
     attestation.
    :vartype symmetric_key: ~dps.models.SymmetricKeyRegistrationResult
    ...
    _attribute_map = {
        'tpm': {'key': 'tpm', 'type': 'TpmRegistrationResult'},
        'x509': {'key': 'x509', 'type': 'X509RegistrationResult'},
        'symmetric_key': {'key': 'symmetricKey', 'type': 'SymmetricKeyRegistrationResult'},
    ...
    def __init__(self, **kwargs):
        super(DeviceRegistrationResult, self).__init__(**kwargs)
        self.tpm = None
        self.x509 = None
