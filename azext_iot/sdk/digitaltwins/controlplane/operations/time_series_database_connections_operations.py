...
class TimeSeriesDatabaseConnectionsOperations(object):
    ...
    def list(
        ...
        deserialized = models.TimeSeriesDatabaseConnectionPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.TimeSeriesDatabaseConnectionPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response

        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{resourceName}/timeSeriesDatabaseConnections'}
    ...
    def get(
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'resourceName': self._serialize.url("resource_name", resource_name, 'str', max_length=63, min_length=3, pattern=r'^(?!-)[A-Za-z0-9-]{3,63}(?<!-)$'),
            'timeSeriesDatabaseConnectionName': self._serialize.url("time_series_database_connection_name", time_series_database_connection_name, 'str', max_length=49, min_length=2, pattern=r'^(?![0-9]+$)(?!-)[a-zA-Z0-9-]{2,49}[a-zA-Z0-9]$')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('TimeSeriesDatabaseConnection', response)
    ...
    def _create_or_update_initial(
        ...
        # Construct body
        body_content = self._serialize.body(time_series_database_connection_description, 'TimeSeriesDatabaseConnection')
    ...
    def create_or_update(
            self, resource_group_name, resource_name, time_series_database_connection_name, properties=None, custom_headers=None, raw=False, polling=True, **operation_config):
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{resourceName}/timeSeriesDatabaseConnections/{timeSeriesDatabaseConnectionName}'}
    ...
    def delete(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{resourceName}/timeSeriesDatabaseConnections/{timeSeriesDatabaseConnectionName}'}
