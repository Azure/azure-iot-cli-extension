...
class IotHubGatewayServiceAPIs(object):
    ...
    :vartype config: IotHubGatewayServiceAPIs
    ...
    def get_configuration(
        ...
        # @digimaun - deserialize as {object} from Configuration
    ...
    def test_configuration_queries(
        ...
        if response.status_code == 200:
            # @digimaun - ConfigurationQueriesTestResponse
            deserialized = self._deserialize('object', response)
    ...
    def get_device(
        ...
        if response.status_code == 200:
            # @digimaun - Change deserialize type to object from Device
            deserialized = self._deserialize('object', response)
    ...
    def get_module(
        ...
        if response.status_code == 200:
            # @digimaun - Change deserialize type to {object} from Module
            deserialized = self._deserialize('{object}', response)
