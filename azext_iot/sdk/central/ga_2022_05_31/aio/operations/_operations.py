...
class DeviceGroupsOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DeviceGroup"]:
...
class DeviceTemplatesOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.DeviceTemplate"]:
...
class DevicesOperations:  # pylint: disable=too-many-public-methods
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.Device"]:
    ...
    @distributed_trace_async
    async def get_component_properties(self, device_id: str, component_name: str, **kwargs: Any) -> Dict[str, Any]:
    ...
    @distributed_trace_async
    async def get_properties(self, device_id: str, **kwargs: Any) -> Dict[str, Any]:
    ...
    @distributed_trace_async
    async def replace_properties(
        self, device_id: str, body: Union[Dict[str, Any], IO], **kwargs: Any
    ) -> Dict[str, Any]:
        """Replace device properties.
    ...
    @distributed_trace_async
    async def update_properties(self, device_id: str, body: JSON, **kwargs: Any) -> Dict[str, Any]:
