...
class IotCentralApiPreviewConfiguration(Configuration):
    """Configuration for IotCentralApiPreview.
    ...
    def __init__(
        ...
        **kwargs  # type: Any
        ...
        super(IotCentralApiPreviewConfiguration, self).__init__(**kwargs)
