...
class UsersOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~iot_central_api_preview.models.UserCollection]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~iot_central_api_preview.models.User
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def set(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~iot_central_api_preview.models.User
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: User, or the result of cls(response)
        :rtype: ~iot_central_api_preview.models.User
        :raises: ~azure.core.exceptions.HttpResponseError
