...
class DevicesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~iot_central_api_preview.models.Device
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def set(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~iot_central_api_preview.models.Device
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Device, or the result of cls(response)
        :rtype: ~iot_central_api_preview.models.Device
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_attestation(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~iot_central_api_preview.models.Attestation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def set_attestation(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~iot_central_api_preview.models.Attestation
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Attestation, or the result of cls(response)
        :rtype: ~iot_central_api_preview.models.Attestation
        :raises: ~azure.core.exceptions.HttpResponseError
    ...
    def get_cloud_properties(
        ...
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.get_cloud_properties.metadata['url']  # type: ignore
        path_format_arguments = {
            'centralDnsSuffixInPath': self._serialize.url("self._config.central_dns_suffix_in_path", self._config.central_dns_suffix_in_path, 'str', skip_quote=True),
            'subdomain': self._serialize.url("self._config.subdomain", self._config.subdomain, 'str'),
            'device_id': self._serialize.url("device_id", device_id, 'str'),
        ...
        return deserialized
    get_cloud_properties.metadata = {'url': '/devices/{device_id}/cloudProperties'}  # type: ignore

    def set_cloud_properties(
        self,
        device_id,  # type: str
        body,  # type: object
        **kwargs  # type: Any
        ...
        # Construct URL
        url = self.set_cloud_properties.metadata['url']  # type: ignore
        path_format_arguments = {
            'centralDnsSuffixInPath': self._serialize.url("self._config.central_dns_suffix_in_path", self._config.central_dns_suffix_in_path, 'str', skip_quote=True),
            'subdomain': self._serialize.url("self._config.subdomain", self._config.subdomain, 'str'),
            'device_id': self._serialize.url("device_id", device_id, 'str'),
        ...
        return deserialized
    set_cloud_properties.metadata = {'url': '/devices/{device_id}/cloudProperties'}  # type: ignore
    ...
    def update_cloud_properties(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> object
        """Update device cloud properties via patch.

        Update cloud property values of a device by device ID.
        ...
        # Construct URL
        url = self.update_cloud_properties.metadata['url']  # type: ignore
        path_format_arguments = {
            'centralDnsSuffixInPath': self._serialize.url("self._config.central_dns_suffix_in_path", self._config.central_dns_suffix_in_path, 'str', skip_quote=True),
            'subdomain': self._serialize.url("self._config.subdomain", self._config.subdomain, 'str'),
            'device_id': self._serialize.url("device_id", device_id, 'str'),
        ...
        return deserialized
    update_cloud_properties.metadata = {'url': '/devices/{device_id}/cloudProperties'}  # type: ignore
    ...
    def get_command_history(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.DeviceCommandCollection"]
        ...
        :rtype: ~azure.core.paging.ItemPaged[~iot_central_api_preview.models.DeviceCommandCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def execute_command(
        ...
        device_id,  # type: str
        command_name,  # type: str
        body,  # type: "_models.DeviceCommand"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DeviceCommand"
        ...
        :type body: ~iot_central_api_preview.models.DeviceCommand
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DeviceCommand, or the result of cls(response)
        :rtype: ~iot_central_api_preview.models.DeviceCommand
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def execute_module_component_command(
        self,
        device_id,  # type: str
        module_name,  # type: str
        component_name,  # type: str
    ...
    def get_credentials(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.DeviceCredentials"
        ...
        :rtype: ~iot_central_api_preview.models.DeviceCredentials
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def set_module_component_properties(
        self,
        device_id,  # type: str
        module_name,  # type: str
        component_name,  # type: str
    ...
    def list_components(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~iot_central_api_preview.models.Collection
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_telemetry_value(
        self,
        device_id,  # type: str
        telemetry_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.DeviceTelemetry"
        ...
        :rtype: ~iot_central_api_preview.models.DeviceTelemetry
        :raises: ~azure.core.exceptions.HttpResponseError
        """
