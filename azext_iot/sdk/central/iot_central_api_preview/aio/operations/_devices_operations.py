...
class DevicesOperations:
    ...
    async def get_cloud_properties(
        self,
        device_id: str,
        **kwargs
    ) -> object:
    ...
    async def set_cloud_properties(
        self,
        device_id: str,
        body: object,
        **kwargs
    ...
    async def update_cloud_properties(
        self,
        device_id: str,
        body: object,
        **kwargs
    ...
    def get_command_history(
        ...
        **kwargs
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~iot_central_api_preview.models.DeviceCommandCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
