...
class CloudInitiatedRollbackPolicy(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype update: ~azure.iot.deviceupdate.models.UpdateInfo
        :keyword failure: Failure conditions to initiate rollback policy. Required.
        :paramtype failure: ~azure.iot.deviceupdate.models.CloudInitiatedRollbackPolicyFailure
        """
        super().__init__(**kwargs)
        self.update = update
...
class Deployment(_serialization.Model):
    ...
    :ivar download_security: The protocol the device should use when downloading the update
     payload.
     Defaults to "https". Known values are: "https" and "http".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype rollback_policy: ~azure.iot.deviceupdate.models.CloudInitiatedRollbackPolicy
        ...
        :keyword download_security: The protocol the device should use when downloading the update
         payload.
         Defaults to "https". Known values are: "https" and "http".
        :paramtype download_security: str or ~azure.iot.deviceupdate.models.DownloadSecurity
        """
        super().__init__(**kwargs)
...
class DeploymentDeviceStatesList(_serialization.Model):
    ...
    :ivar value: The DeploymentDeviceState items on this page. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeploymentDeviceState items on this page. Required.
...
class Device(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype last_attempted_update: ~azure.iot.deviceupdate.models.UpdateInfo
        ...
        :paramtype installed_update: ~azure.iot.deviceupdate.models.UpdateInfo
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword device_class_properties: The device class properties that are used to calculate the
         device class Id. Required.
        :paramtype device_class_properties: ~azure.iot.deviceupdate.models.DeviceClassProperties
        :keyword best_compatible_update: Update that is the highest version compatible with this device
         class.
        :paramtype best_compatible_update: ~azure.iot.deviceupdate.models.UpdateInfo
        """
        super().__init__(**kwargs)
        self.device_class_id = device_class_id
...
class DeviceClassesList(_serialization.Model):
    ...
    :ivar value: The DeviceClass items on this page. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeviceClass items on this page. Required.
...
class DeviceClassProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype contract_model: ~azure.iot.deviceupdate.models.ContractModel
...
class DeviceClassSubgroupsList(_serialization.Model):
    ...
    :ivar value: The DeviceClassSubgroup items on this page. Required.
    :vartype value: list[~azure.iot.deviceupdate.models.DeviceClassSubgroup]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeviceClassSubgroup items on this page. Required.
        :paramtype value: list[~azure.iot.deviceupdate.models.DeviceClassSubgroup]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DeviceClassSubgroupUpdatableDevicesList(_serialization.Model):
    ...
    :ivar value: The DeviceClassSubgroupUpdatableDevices items on this page. Required.
    :vartype value: list[~azure.iot.deviceupdate.models.DeviceClassSubgroupUpdatableDevices]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeviceClassSubgroupUpdatableDevices items on this page. Required.
        :paramtype value: list[~azure.iot.deviceupdate.models.DeviceClassSubgroupUpdatableDevices]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword state: Aggregate device health state. Required. Known values are: "healthy" and
         "unhealthy".
        :paramtype state: str or ~azure.iot.deviceupdate.models.DeviceHealthState
        ...
        :paramtype health_checks: list[~azure.iot.deviceupdate.models.HealthCheck]
        """
        super().__init__(**kwargs)
        self.device_id = device_id
        self.module_id = module_id
...
class DeviceHealthList(_serialization.Model):
    ...
    :ivar value: The DeviceHealth items on this page. Required.
    :vartype value: list[~azure.iot.deviceupdate.models.DeviceHealth]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeviceHealth items on this page. Required.
        :paramtype value: list[~azure.iot.deviceupdate.models.DeviceHealth]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class DeviceOperationsList(_serialization.Model):
    ...
    :ivar value: The DeviceOperation items on this page. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The DeviceOperation items on this page. Required.
...
class FileImportMetadata(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword url: Azure Blob location from which the update file can be downloaded by Device
         Update for IoT Hub. This is typically a read-only SAS-protected blob URL with
         an expiration set to at least 4 hours. Required.
        :paramtype url: str
        """
...
class HealthCheck(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype result: str or ~azure.iot.deviceupdate.models.HealthCheckResult
        """
        super().__init__(**kwargs)
        self.name = name
        self.result = result
...
class LogCollectionDetailedStatusList(_serialization.Model):
    ...
    :ivar value: The LogCollectionOperationDetailedStatus items on this page. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The LogCollectionOperationDetailedStatus items on this page. Required.
...
class LogCollectionList(_serialization.Model):
    ...
    :ivar value: The LogCollection items on this page. Required.
    :vartype value: list[~azure.iot.deviceupdate.models.LogCollection]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The LogCollection items on this page. Required.
        :paramtype value: list[~azure.iot.deviceupdate.models.LogCollection]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class Step(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype handler_properties: dict[str, any]
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword related_files: Optional related files metadata used together DownloadHandler metadata
         to
         download payload file.
        :paramtype related_files: list[~azure.iot.deviceupdate.models.UpdateFileBase]
        :keyword download_handler: Optional download handler for utilizing related files to download
         payload file.
        :paramtype download_handler: ~azure.iot.deviceupdate.models.UpdateFileDownloadHandler
...
class UpdateInfoList(_serialization.Model):
    ...
    :ivar value: The UpdateInfo items on this page. Required.
    :vartype value: list[~azure.iot.deviceupdate.models.UpdateInfo]
    :ivar next_link: The link to the next page of items.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The UpdateInfo items on this page. Required.
        :paramtype value: list[~azure.iot.deviceupdate.models.UpdateInfo]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
...
class UpdateOperationsList(_serialization.Model):
    ...
    :ivar value: The UpdateOperation items on this page. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword value: The UpdateOperation items on this page. Required.
