...
class DeviceManagementOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~deviceupdateclient.aio.DeviceUpdateClient`'s
    ...
    def list_device_classes(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeviceClass]
    ...
    def list_installable_updates_for_device_class(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.UpdateInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_devices(
        ...
        **kwargs: Any
        ...
        :param filter: Restricts the set of devices returned. You can filter on GroupId, DeviceClassId,
         or GroupId and DeploymentStatus. Default value is None.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either Device or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.Device]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_groups(
        ...
        **kwargs: Any
        ...
        :param order_by: Orders the set of groups returned. You can order by any combination of
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.Group]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_best_updates_for_group(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeviceClassSubgroupUpdatableDevices or the result
         of cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeviceClassSubgroupUpdatableDevices]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_deployments_for_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.Deployment]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_device_class_subgroups_for_group(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeviceClassSubgroup]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_device_states_for_device_class_subgroup_deployment(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either DeploymentDeviceState or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeploymentDeviceState]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    async def get_operation(
        ...
        **kwargs: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: DeviceOperation or None or the result of cls(response)
        :rtype: ~deviceupdateclient.models.DeviceOperation or None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    def list_operations(
        ...
        **kwargs: Any
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeviceOperation]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_log_collections(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.LogCollection"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.LogCollection]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    def list_device_health(
        ...
        **kwargs: Any
        ...
        :param filter: Filter list by specified properties. Required.
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either DeviceHealth or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~deviceupdateclient.models.DeviceHealth]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_list_device_health_request(
                    instance_id=self._config.instance_id,
                    filter=filter,
                    api_version=api_version,
                    template_url=self.list_device_health.metadata['url'],
                    headers=_headers,
                    params=_params,
                )
                request = _convert_request(request)
    ...
    list_device_health.metadata = {'url': "/deviceUpdate/{instanceId}/management/deviceDiagnostics/deviceHealth"}  # type: ignore
