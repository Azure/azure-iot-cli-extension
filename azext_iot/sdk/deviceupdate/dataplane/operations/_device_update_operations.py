...
class DeviceUpdateOperations:
    ...
    def begin_import_update(
        ...
        **kwargs: Any
        ...
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no
         Retry-After header is present.
        :return: An instance of LROPoller that returns either Update or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.iot.deviceupdate.models.Update]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_import_update(
        ...
        **kwargs: Any
        ...
        :param update_to_import: The update to be imported (see schema
         https://json.schemastore.org/azure-deviceupdate-import-manifest-5.0.json for
         details). Is either a list type or a IO type. Required.
