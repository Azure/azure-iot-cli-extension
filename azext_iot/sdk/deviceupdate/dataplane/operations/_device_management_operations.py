...
def build_list_device_classes_request(
    ...
    **kwargs: Any
    ...
    api_version = kwargs.pop('api_version', _params.pop('api-version', "2026-06-01"))  # type: str
...
class DeviceManagementOperations:  # pylint: disable=too-many-public-methods
    ...
    def update_device_class(
        ...
        **kwargs: Any
        ...
        :param device_class_patch: The device class json merge patch body. Currently only supports
         patching
         friendlyName. Is either a model type or a IO type. Required.
        :type device_class_patch: ~azure.iot.deviceupdate.models.PatchBody or IO
    ...
    def start_log_collection(
        ...
        **kwargs: Any
        ...
        :param log_collection: The log collection properties. Is either a model type or a IO type.
         Required.
        :type log_collection: ~azure.iot.deviceupdate.models.LogCollection or IO
    ...
    def create_or_update_deployment(
        ...
        **kwargs: Any
        ...
        :type deployment: ~azure.iot.deviceupdate.models.Deployment or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
