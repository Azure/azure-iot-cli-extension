...
def load_pnp_commands(self, _):
    ...
    with self.command_group(
        "iot pnp role-assignment", command_type=pnp_repo_ops
    ) as cmd_group:
    ...
    with self.command_group("iot pnp repo", command_type=pnp_repo_ops) as cmd_group:
        cmd_group.command("create", "iot_pnp_tenant_create")
        cmd_group.command("list", "iot_pnp_tenant_show")

    with self.command_group("iot pnp model", command_type=pnp_model_ops) as cmd_group:
