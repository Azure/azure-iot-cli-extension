...
class DeviceGroupsOperations:
    """DeviceGroupsOperations async operations.
    ...
    def list(
        self,
        **kwargs
    ) -> AsyncIterable["_models.DeviceGroupCollection"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~iot_central_api_preview.models.DeviceGroupCollection]
