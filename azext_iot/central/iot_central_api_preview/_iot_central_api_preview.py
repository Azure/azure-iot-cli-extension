...
class IotCentralApiPreview(object):
    ...
    :vartype api_tokens: iot_central_api_preview.operations.ApiTokensOperations
    :ivar continuous_data_exports: ContinuousDataExportsOperations operations
    :vartype continuous_data_exports: iot_central_api_preview.operations.ContinuousDataExportsOperations
    :ivar device_groups: DeviceGroupsOperations operations
    :vartype device_groups: iot_central_api_preview.operations.DeviceGroupsOperations
    :ivar devices: DevicesOperations operations
    :vartype devices: iot_central_api_preview.operations.DevicesOperations
    :ivar device_templates: DeviceTemplatesOperations operations
    :vartype device_templates: iot_central_api_preview.operations.DeviceTemplatesOperations
    :ivar jobs: JobsOperations operations
    :vartype jobs: iot_central_api_preview.operations.JobsOperations
    :ivar roles: RolesOperations operations
    :vartype roles: iot_central_api_preview.operations.RolesOperations
    :ivar users: UsersOperations operations
    :vartype users: iot_central_api_preview.operations.UsersOperations
