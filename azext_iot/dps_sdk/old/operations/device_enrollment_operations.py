...
class DeviceEnrollmentOperations(object):
    ...
    def get(
        ...
        :return: Enrollment or ClientRawResponse if raw=true
        :rtype:
         ~microsoft.azure.management.provisioningservices.models.Enrollment or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('Enrollment', response)
    ...
    def create_or_update(
        ...
        :type enrollment:
         ~microsoft.azure.management.provisioningservices.models.Enrollment
        ...
        # Construct body
        body_content = self._serialize.body(enrollment, 'Enrollment')
    ...
    def bulk_operation_method(
        ...
        :type bulk_operation:
         ~microsoft.azure.management.provisioningservices.models.BulkOperation
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: BulkOperationResult or ClientRawResponse if raw=true
        :rtype:
         ~microsoft.azure.management.provisioningservices.models.BulkOperationResult
        ...
        # Construct body
        body_content = self._serialize.body(bulk_operation, 'BulkOperation')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('BulkOperationResult', response)
