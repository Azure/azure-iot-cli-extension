...
def load_deviceprovisioningservice_help():
  ...
  long-summary: |
    ...
    --csr (alias --csr-file-path) accepts PEM or base64 DER PKCS #10, inline or from a file.
    Its signature must be valid and its Common Name must match --registration-id. The REST wire value is base64 DER.
