...
class DeviceRegistrationProvider():
    def __init__(
        ...
        self.cmd = cmd
        self.dps_name_or_hostname = dps_name_or_hostname
    ...
    def _get_idscope(self) -> str:
        ...
        dps_name_or_hostname = target['entity'].split(".")[0]
        return discovery.get_id_scope(resource_name=dps_name_or_hostname, rg=self.resource_group_name)
    ...
    def _validate_attestation_params(
        ...
        if device_symmetric_key:
            if not compute_key:
                ...
                self.device_symmetric_key = iot_dps_compute_device_key(
                    ...
                    dps_name_or_hostname=self.dps_name_or_hostname,
        ...
        elif not (self.dps_name_or_hostname or self.login):
