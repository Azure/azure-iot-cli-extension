...
def load_arguments(self, _):
    ...
    with self.argument_context("iot edge image terms") as context:
        context.argument(
            "offerId",
        ...
        context.argument(
            "urn",
            options_list=["--urn"],
            help="URN, in the format of 'publisherId:offerId:planId'. If specified, other argument values should be omitted.",
        )
        context.argument(
            "azureSub",
            options_list=["--sub", "-s"],
