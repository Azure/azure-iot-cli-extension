...
| `azext_dt_max_model_per_batch`	| Digital Twin Model Tests	| The maximum value of process models in batches if models to process exceed the API limit. Defaults to 30.	|
